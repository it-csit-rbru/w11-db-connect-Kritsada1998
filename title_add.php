            ...
            <div class="row">
                ...
                <?php
                    if(isset($_GET['submit'])){  //ประกาศตัวแปร
                        $ttl_name = $_GET['ttl_name']; //นำค่าฟอร์มโยนเข้า ttl_name
                        $sql = "insert into title (ttl_name) values ('$ttl_name')"; //เข้าดาต้าเบส
                        echo $sql;
                        include 'connectdb.php'; 
                        mysqli_query($conn,$sql); //$conn นำมาจาก Connectdb.php
                        mysqli_close($conn);
